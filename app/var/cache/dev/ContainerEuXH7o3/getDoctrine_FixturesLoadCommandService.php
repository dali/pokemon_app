...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/MoveFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/PokemonFixtures.php';
        ...
        $b = ($container->privates['App\\Repository\\TypeRepository'] ?? $container->load('getTypeRepositoryService'));

        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ItemFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\MoveFixtures($b), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\PokemonFixtures($b), 'groups' => []]]);
